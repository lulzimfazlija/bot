...
import QnACardBuilder  from '../utils/qnaCardBuilder';
import { QnAMaker } from 'botbuilder-ai';

// Default parameters
const DefaultThreshold = 0.3;
const DefaultTopN = 3;
const DefaultNoAnswer = `We don't have any answer yet for that!`;
...
class QnAMakerBaseDialog extends ComponentDialog {
    _qnaMakerService: any;
    /**
     * Core logic of QnA Maker dialog.
     * @param {QnAMaker} qnaService A QnAMaker service object.
     */
    constructor(qnaService: QnAMaker) {
    ...
    */
    async callGenerateAnswerAsync(stepContext: WaterfallStepContext) {
    ...
    * @param {WaterfallStepContext} stepContext contextual information for the current step being executed.
    */
    async callTrain(stepContext: WaterfallStepContext) {
    ...
    * @param {WaterfallStepContext} stepContext contextual information for the current step being executed.
    */
    async checkForMultiTurnPrompt(stepContext: WaterfallStepContext) {
    ...
    * @param {WaterfallStepContext} stepContext contextual information for the current step being executed.
    */
    async displayQnAResult(stepContext: WaterfallStepContext) {
        var dialogOptions = getDialogOptionsValue(stepContext);
        var qnaDialogResponseOptions = dialogOptions[QnADialogResponseOptions];
...
export { QnAMakerBaseDialog, QNAMAKER_BASE_DIALOG, DefaultThreshold, DefaultTopN, DefaultCardTitle, DefaultNoAnswer, DefaultCardNoMatchText, DefaultCardNoMatchResponse, QnAOptions, QnADialogResponseOptions};
